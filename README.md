...
> Suggest deleting the following paragraph
...
I think it was appropriate for the purpose for which I wrote it. It was an ajunct to the lesson that very large methods can be broken down into smaller classes containing smaller methods. Adding lots of explanatory comments would have detracted from that point.
...
>Recommend we delete the Eiffel distraction.

The constraints on the arguments could be written in executable preconditions following Bertrand Meyer's idea of _Design by Contract_ used in the Eiffel language.
